...
export function anchoredTimeScale(rowCount,startBars,startOffset,deltaX,ratio=.5){const bars=Math.max(20,Math.min(1000,Math.round(startBars+deltaX/5))),oldStart=rowCount-startOffset-startBars,anchor=oldStart+ratio*(startBars-1),newStart=anchor-ratio*(bars-1);return{bars,offset:rowCount-(newStart+bars),anchor}}
